{
    ...
    'assets': {
        ...
        'web.assets_backend': [
            ...
            'RealEstateModule/static/src/js/custom_contact_kanban.js',
            'RealEstateModule/static/src/xml/custom_contact_list.xml',
            'RealEstateModule/static/src/js/custom_contact_list.js',
        ]
    },
