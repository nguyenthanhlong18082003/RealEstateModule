...
class FriendRequest(models.Model):
    ...
    def show_list(self):
        context = {}
        view_kanban_id = self.env.ref('RealEstateModule.custom_friend_request_form_view').id
        action = {
...
class PartnerRequest(models.Model):
    ...
    def show_list(self):
        context = {}
        view_kanban_id = self.env.ref('RealEstateModule.custom_partner_request_form_view').id
        action = {
            'type': 'ir.actions.act_window',
...
class TeamRequest(models.Model):
    ...
    def show_list(self):
        context = {}
        view_kanban_id = self.env.ref('RealEstateModule.custom_team_request_form_view').id
        action = {
            'type': 'ir.actions.act_window',
