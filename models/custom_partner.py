...
class CustomFriendPartner(models.Model):
    ...
    def add_all_partners(self):
        ...
        partner_ids = []
        for user in users:
            if (user.has_group("RealEstateModule.access_res_module_user")) and (user.partner_id.id not in current_partner.friend_partner_ids.ids) and (user.partner_id.id not in sent_requests) and (user.partner_id.id != current_partner.id):
                _logger.info("\n\n\n %s \n\n",user.partner_id.id)
...
class CustomPartner(models.Model):
    ...
    def add_all_partners(self):
        ...
        partner_ids = []
        for user in users:
            if (user.has_group("RealEstateModule.access_res_module_user")) and (user.partner_id.id not in current_partner.team_partner_ids.ids) and (user.partner_id.id in current_partner.friend_partner_ids.ids) and (user.partner_id.id not in sent_requests) and (user.partner_id.id != current_partner.id):
                partner_ids.append(user.partner_id.id)
...
class CustomPartner(models.Model):
    ...
    def add_all_partners(self):
        ...
        partner_ids = []
        for user in users:
            if (user.has_group("RealEstateModule.access_res_module_user")) and (user.partner_id.id not in current_partner.team_partner_ids.ids) and (user.partner_id.id in current_partner.co_partner_ids.ids) and (user.partner_id.id not in sent_requests) and (user.partner_id.id != current_partner.id):
                partner_ids.append(user.partner_id.id)
