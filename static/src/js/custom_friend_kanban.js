...
export class KanbanControllerExtend extends KanbanController {
  ...
  async onClickTest() {
    ...
    if(currentContactType === "Bạn bè") {
      form_view_ref = "RealEstateModule.view_partner_form_with_friend";
    } 
    else if(currentContactType === "Đối tác") {
      form_view_ref = "RealEstateModule.view_partner_form_with_co_partner";
    }
    else if(currentContactType === "Đồng nghiệp") {
      form_view_ref = "RealEstateModule.view_partner_form_with_team";
    }
